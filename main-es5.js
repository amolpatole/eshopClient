(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                { path: "products/add", component: _components_add_product_add_product_component__WEBPACK_IMPORTED_MODULE_3__["AddProductComponent"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(userSVC, router) {
                    ...
                    this.router = router;
                    this.title = 'SubmitFormWithImageClient';
                    this.userSVC.currentUser.subscribe(function (x) { return _this.currentUser = x; });
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _interceptors_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./interceptors/auth.interceptor.service */ "./src/app/interceptors/auth.interceptor.service.ts");
            ...
            AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
                    declarations: [
                        ...
                        _components_add_product_add_product_component__WEBPACK_IMPORTED_MODULE_7__["AddProductComponent"],
                    ...
                    providers: [
                        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: _interceptors_auth_interceptor_service__WEBPACK_IMPORTED_MODULE_11__["AuthInterceptorService"], multi: true }
                    ],
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AddProductComponent = /** @class */ (function () {
                function AddProductComponent(catalogSVC, router) {
                ...
                AddProductComponent.prototype.save = function (form, image) {
                    var _this = this;
                    if (form.valid) {
                        ...
                        this.catalogSVC.addProduct(formData).subscribe(function (result) {
                            console.log(result);
                            alert("Success");
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(catalogSVS) {
                    this.catalogSVS = catalogSVS;
                    this.products = this.catalogSVS.getProducts();
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(formBuilder, router, userSVC) {
                ...
                LoginComponent.prototype.login = function () {
                    ...
                    if (this.loginForm.valid) {
                        ...
                        this.userSVC.getToken(username, password).subscribe(function (result) {
                            if (result) {
                                // To save the user detial as observable
                                _this.userSVC.saveUserState(result);
                                _this.router.navigate(['/']);
                            }
                            else {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                function RegisterComponent(formBuilder, userSvc) {
                    this.formBuilder = formBuilder;
                    this.userSvc = userSvc;
                    this.userForm = this.formBuilder.group({
                        ...
                        mobile: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]("", _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].maxLength(10)])),
                    });
                }
                ...
                RegisterComponent.prototype.register = function () {
                    if (this.userForm.valid) {
                        ...
                        user.role = "user";
                        this.userSvc.addUser(user).subscribe(function (result) {
                            console.log(result);
                            alert("Successfully");
                        }, function (err) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthInterceptorService = /** @class */ (function () {
                function AuthInterceptorService(userSVC) {
                    this.userSVC = userSVC;
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CatalogService = /** @class */ (function () {
                function CatalogService(httpClient) {
                    this.httpClient = httpClient;
                    //readonly API_BASE_URL: string = "http://localhost:58348/api/Catalog";
                    this.API_BASE_URL = "https://amol-catalogapi.azurewebsites.net/api/Catalog";
                }
                CatalogService.prototype.addProduct = function (formData) {
                    return this.httpClient.post(this.API_BASE_URL + "/product", formData);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                function UserService(http) {
                    ...
                    this.apiUrl = "https://amol-identityapi.azurewebsites.net/api/auth";
                ...
                UserService.prototype.removeUserState = function () {
        ...
        /***/ (function (module, exports, __webpack_require__) {
            module.exports = __webpack_require__(/*! C:\Users\r1m1nrao\Documents\Training_Project\Angular\SubmitFormWithImageClient\src\main.ts */ "./src/main.ts");
            /***/ 
        })
    }, [[0, "runtime", "vendor"]]]);
