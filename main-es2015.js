...
let AddProductComponent = class AddProductComponent {
    ...
    save(form, image) {
        if (form.valid) {
            ...
            this.catalogSVC.addProduct(formData).subscribe(result => {
                console.log(result);
                alert("Success");
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, router, userSVC) {
    ...
    login() {
        if (this.loginForm.valid) {
            ...
            this.userSVC.getToken(username, password).subscribe(result => {
                if (result) {
...
let RegisterComponent = class RegisterComponent {
    constructor(formBuilder, userSvc) {
        this.formBuilder = formBuilder;
        this.userSvc = userSvc;
    ...
    register() {
        if (this.userForm.valid) {
            ...
            user.role = "user";
            this.userSvc.addUser(user).subscribe(result => {
                console.log(result);
                alert("Successfully");
            }, err => {
